            ...
            <div class="col-md-8 col-md-offset-2">
	            <div class="form-group">
	                    <div class="form-material floating">
	                        ...
	                        <label for="material-text2">Information Name</label>
	                    </div>
	            </div>
	            <div class="form-group">
	                    <div class="form-material floating">
	                        <input class="form-control" id="material-password2" name="displayName" type="text">
	                        <label for="material-password2">Information Display Name</label>
	                    </div>
	            </div>
             	<div class="form-group">
                        <div class="form-material floating">
                            ...
                            <label for="example2-select2">Information Attribute</label>
                        </div>
                </div>
	         </div>
            </div>
